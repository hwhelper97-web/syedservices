...
import { FiSend, FiLoader, FiMessageSquare, FiRefreshCw, FiCheck, FiHeadphones, FiVolume2 } from "react-icons/fi";
...
export default function ClientMessagesPage() {
  ...
  useEffect(() => {
    ...
    // Auto-poll messages every 3 seconds for live conversation
  ...
  const pollMessages = async () => {
    try {
      ...
      if (res.ok) {
        ...
        // If new message from support received
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h3 className="text-lg font-black text-white tracking-tight">Support Desk</h3>
            ...
            <p className="text-xs text-slate-400 mt-0.5">
              Direct line to our visa officers and case processing specialists
            </p>
          </div>
        </div>
      ...
      <div className="bg-[#0f172a] border border-slate-800 rounded-[2.5rem] p-6 shadow-xl flex flex-col h-[550px] relative overflow-hidden">
        ...
        >
          <input
            ...
            placeholder="Type your message to Syed Services support... (Press Enter)"
