...
import { FiSend, FiLoader, FiMessageSquare, FiUser, FiRefreshCw } from "react-icons/fi";
      ...
      <div className="bg-[#0f172a] border border-slate-800 rounded-[2.5rem] p-6 shadow-xl flex flex-col h-[550px] relative overflow-hidden">
        ...
        <form onSubmit={handleSendMessage} className="flex gap-3 border-t border-slate-800 pt-4 bg-slate-900/10 relative z-10">
          <input
            ...
            className="flex-1 px-4 py-3.5 bg-slate-950/60 border border-slate-800 focus:border-yellow-400/50 rounded-2xl text-sm focus:outline-none text-white placeholder-slate-550"
          />
          <button
            type="submit"
